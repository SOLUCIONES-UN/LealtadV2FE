...
const getDepartamento = () => {
    return new Promise((resolve, reject) => {
        ...
        fetch(`${url}Departamento`, requestOptions)
            ...
            .then((data) => {
                // Extraer el array de departamentos del objeto recibido
                ...
                if (Array.isArray(result)) {
                    ...
                    // Resto del código para asignar event listeners y resolver la promesa
                    // ...
...
function limpiarFormulario() {
    ...
    // $("#previewNotificacion").attr("src", "#").hide();
    // $("[for='imgCampaniaEdit']").text("Seleccionar archivo");
    // $("[for='imgNotificacionEdit']").text("Seleccionar archivo");
